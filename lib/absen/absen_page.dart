...
import 'package:kehadiran/absen/image_page.dart';
...
class _AbsenPageState extends State<AbsenPage> {
  ...
  set _imageFile(XFile? value) {
    _fpFile = value == null ? null : [value];
    bytes = File(_fpFile![0].path).readAsBytesSync();
                            ...
                            try {
                              ...
                              if (pickedFile != null) {
                                setState(() {
                                  ...
                                  Get.to(
                                      ImagesPage(filePath: _fpFile![0].path));
                                });
                              }
                            } catch (e) {
                              setState(() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          gradient: LinearGradient(
              colors: [Color(0xFF3995DB), Color(0xFF59B9E9), Color(0xFF6CB2D3)],
